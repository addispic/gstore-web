        ...
        <div className='max-w-[1024px] mx-auto flex gap-x-3 sm:gap-x-6 lg:gap-x-12'>
            ...
            <div className='w-[55%] bg-green-600 rounded-md overflow-hidden py-5 px-3 sm:px-3 md:px-3 lg:px-5 xl:px-10 text-white h-[88vh] flex flex-col justify-between'>
                ...
                <header>
                    {/* logo */}
                    <NavLink to={'/'}>
                        <p className='text-lg font-black text-neutral-200'>g<span className='text-xl'>store</span></p>
                    </NavLink>
                </header>
                {/* middle text */}
                <div className='my-5'>
                    ...
                    <p className='mt-5'>
                        Lorem ipsum dolor, sit amet consectetur adipisicing elit. Quod veritatis inventore maiores amet itaque eos debitis modi odio repudiandae sit delectus, nulla, fugiat minus?
                    </p>
                </div>
                {/* footer */}
                <div>
                    ...
                    <div className='p-5 rounded-md bg-green-700'>
                        <div>
                            <p className='text-sm'>
                                Lorem ipsum dolor sit amet consectetur adipisicing elit. Cumque nulla harum quo. Corrupti blanditiis eaque voluptatem laborum ratione, maxime doloribus suscipit molestiae distinctio similique?
                            </p>
                        </div>
                        {/* author */}
                        <div className='flex items-center gap-x-3 mt-3'>
                            ...
                            <div className='w-[32px] aspect-square rounded-full overflow-hidden'>
                                <img className='w-full h-full object-center object-cover' src="https://img.freepik.com/free-photo/young-bearded-man-with-striped-shirt_273609-5677.jpg?ga=GA1.2.566907491.1728623541&semt=ais_hybrid" alt="" />
                            </div>
                            {/* username */}
                            <div >
                                <p className='font-semibold text-sm text-neutral-200'>Addis F.</p>
